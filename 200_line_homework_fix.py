...
while True:
    ...
    orc_classes_hp = {
                      ("orc", "tank"): orc_hp*t_mod,
                      ("orc", "berserker"): orc_hp*b_mod,
                      ("orc", "shooter"): orc_hp*s_mod,
                      ("orc", "wizard"): orc_hp*w_mod
                     }
    
    human_classes_hp = {
                        ("human", "tank"): human_hp*t_mod,
                        ("human", "berserker"): human_hp*b_mod,
                        ("human", "shooter"): human_hp*s_mod,
                        ("human", "wizard"): human_hp*w_mod
                       }
    
    elf_classes_hp = {
                      ("elf", "tank"): elf_hp*t_mod,
                      ("elf", "berserker"): elf_hp*b_mod,
                      ("elf", "shooter"): elf_hp*s_mod,
                      ("elf", "wizard"): elf_hp*w_mod
                     }
    
    gnoll_classes_hp = {
                        ("gnoll", "tank"): gnoll_hp*t_mod,
                        ("gnoll", "berserker"): gnoll_hp*b_mod,
                        ("gnoll", "shooter"): gnoll_hp*s_mod,
                        ("gnoll", "wizard"): gnoll_hp*w_mod
                       }
